<?php
    ...
    class Validation {
        ...
        public function pattern($name){
            ...
            if($name == 'array'){
                ...
                if(!is_array($this->value)){
                    $this->errors[$this->name] = 'Le format du champ '.$this->name.' n\'est pas valide.';
                }
        ...
        public function equal($value){
            ...
            if($this->value != $value){
                $this->errors[$this->name] = 'La valeur du champ '.$this->name.' ne correspond pas.';
            }
            return $this;
        ...
        public function maxSize($size){
            ...
            if($this->file['error'] != 4 && $this->file['size'] > $size){
                $this->errors[$this->name] = 'Le fichier'.$this->name.' dépasse la taille maximale de '.number_format($size / 1048576, 2).' MB.';
            }
            return $this;
